	...
	<main class="container mx-auto px-4 py-4">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                <?php foreach ($data['entry'] as $list): ?>
                    ...
                    <?php
                        // Cek apakah VCH.ScheduledStart ada
                        if (isset($list['extensions']['VCH.ScheduledStart'])) {
                            ...
                            // Jika ada jadwal, arahkan ke live.php
                            $link = "live.php?event=" . $list['id'];

                        } else {
                            // Jika tidak ada VCH.ScheduledStart, arahkan ke explore.php
                            $displayTime = 'Jadwal tidak tersedia';
                            $link = "explore.php?query=" . $list['id'];
                        }
                    ?>
